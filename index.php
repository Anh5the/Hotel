...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">lehoanganh2142003@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>0849099786</li>	
					<li class="s-bar">
						<div class="search">
	...
	<div class="banner-bottom">
		<div class="container">	
			<div class="agileits_banner_bottom">
				<h3><span>TRẢI NGHIỆM KỲ NGHỈ THÚ VỊ, TẬN HƯỞNG ƯU ĐÃI HẤP DẪN</span>TÌM SỰ ĐÓN TIẾP THÂN THIỆN CỦA CHÚNG TÔI
</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					...
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">BAN CÔNG HƯỚNG BIỂN</h4>
							<span class="cbp-ig-category">SUN RISE</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">CAFE LỚN</h4>
							<span class="cbp-ig-category">SUN RISE</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">PHỦNG HỘ WIFI</h4>
							<span class="cbp-ig-category">SUN RISE</span>
						</div>
					</li>
				</ul>
		   ...
		   <div class="advantage-bottom">
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					...
					<p><i class="fa fa-check" aria-hidden="true"></i>Phòng trang trí đẹp, có máy lạnh</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>0849099786</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">lehoanganh2142003@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> 28/10 Văn Chung, Phường 13, Tân Bình</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2023 SUNRISE . Nhóm 5 | Design by <a href="index.php">NHÓM 5</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
